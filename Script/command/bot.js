...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "@রাধার ভাতার") || (event.body.toLowerCase() == "Damian Desmond") || (event.body.toLowerCase() == "@ডিজে মে'রি ইভান") || (event.body.toLowerCase() == "ইভান")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ EVAN ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ROBIN.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- 61576825768286\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:EVAN ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস ইভান আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is EVAN ッ❤️ তাকে সবাই রবিন নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "jerryin") || (event.body.toLowerCase() == "জেরিন ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস ইভান এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "ফুল") || (event.body.toLowerCase() == "চেরি")) {
     return api.sendMessage("খবরদার কেউ এই নাম ধরে ডাক দিবানা এটা আমার বস ইভান এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "mim") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস ইভান এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@অগ্নিবীর আর্য ") || (event.body.toLowerCase() == "শাওন")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস ইভান'এর বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "@ডিজে মে'রি ইভান") || (event.body.toLowerCase() == "@রাধার ভাতার")) {
     return api.sendMessage("️এত মেনশন না দিয়ে আমা বস ইভানকে একটা গফ দে 🥰", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "জেরিন ") || (event.body.toLowerCase() == "জেরি") || (event.body.toLowerCase() == "জেরি") || (event.body.toLowerCase() == "ফুল") || (event.body.toLowerCase() == "কিউট") || (event.body.toLowerCase() == "ফারহা")) {
     return api.sendMessage("চুপ শালা", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami sadhin") || (event.body.toLowerCase() == "kire")) {
